<template>
    <section id='footerCtrl'>
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="position:absolute;width:0;height:0">
        ...
        <section @click = "gotoAddress({path: '/oces/home'})" class="guide_item">
          <svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('home') !== -1? '#findActive' : '#find'"></use>
            </svg>
            <span>首页</span>
        </section>
        <section @click = "gotoAddress({path: '/oces/courses'})" class="guide_item">
          <svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('courses') !== -1? '#orderActive' : '#order'"></use>
            </svg>
            <span>全部课程</span>
        </section>
        <section @click = "gotoAddress('/oces/my')" class="guide_item">
          <svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('my') !== -1? '#profileActive' : '#profile'"></use>
            </svg>
            <span>我的学习</span>
        </section>
    </section>
